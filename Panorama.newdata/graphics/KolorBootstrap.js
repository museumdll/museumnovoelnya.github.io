...
function eventKrpanoLoaded () {
	...
	ktools.I18N.getInstance().initLanguage('en', crossDomainTargetUrl+'Panorama.newdata/Panorama.new_messages_','.xml');
	krpanoLoaded = true;
...
function addKolorBox(pPlugID)
{
	...
	{
		var kolorBoxCSS = new ktools.CssStyle("KolorBoxCSS", crossDomainTargetUrl+"Panorama.newdata/graphics/KolorBox/kolorBox.css");
		var kolorBoxJS = new ktools.Script("KolorBoxJS", crossDomainTargetUrl+"Panorama.newdata/graphics/KolorBox/KolorBox.min.js", [], true);
